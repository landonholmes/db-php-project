...
<div class="row quiz-question-row">
    <div class="col-sm-12">
        ...
        <hr />
        <a class="btn btn-sm btn-info" id="new-question-button" style="float:right;margin-top:5px;margin-bottom: 100px;">New Question</a>
    </div>
    <script>
        var PAGE = {
        ...
        $("div.quiz-question-row").on("click","div.toggleIsAnswer",toggleIsAnswerForOption);
